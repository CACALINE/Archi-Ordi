...
int new_pc = [
    ...
    icode == LOOP && ifun == 0 && valE != 0 : valC;                 # branche pour LOOP
    icode == LOOP && ifun == 3 && valE != 0 && Bch == 1 : valC;     # branche pour LOOPE
    icode == LOOP && ifun == 4 && valE != 0 && Bch == 1 : valC;     # branche pour LOOPNE
    icode == LOOP : valP;                                           # Sinon instruction suivnate par défaut
